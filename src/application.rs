    ...
    pub fn run(&mut self) {
        while self.app.wait() {
            if let Some(action) = self.receiver.recv() {
                match action {
                    Action::FileNew => println!("FileNew"),
                    Action::FileSave => println!("FileSave"),
                    Action::FileSaveAs => println!("FileSaveAs"),
                    Action::FileConfigure => self.on_file_configure(),
                    Action::FileOpen => self.on_file_open(),
                    Action::FileQuit => self.on_file_quit(),
                    Action::ListNew => println!("ListNew"),
                    Action::ListRename => println!("ListRename"),
                    Action::ListMoveUp => println!("ListMoveUp"),
                    Action::ListMoveDown => println!("ListMoveDown"),
                    Action::ListMoveTo => println!("ListMoveTo"),
                    Action::ListMerge => println!("ListMerge"),
                    Action::ListCopy => println!("ListCopy"),
                    Action::ListExport => println!("ListExport"),
                    Action::ListImport => println!("ListImport"),
                    Action::ListDelete => println!("ListDelete"),
                    Action::ListUndelete => println!("ListUndelete"),
